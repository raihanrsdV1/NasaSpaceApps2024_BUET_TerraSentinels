...
const DistanceSlider: React.FC<DistanceSliderProps> = ({ maxDistance, setMaxDistance }) => {
  return (
    <div className="w-full max-w-lg p-6 bg-green-50 shadow-lg rounded-lg">
      <h2 className="text-xl font-bold text-green-700 mb-2">Adjust Search Radius</h2>
      <p className="text-gray-700 mb-4">Use the slider to set the maximum distance for searching water sources.</p>
